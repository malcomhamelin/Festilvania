...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  ven. 26 oct. 2018 à 08:42
...
INSERT INTO `evenement` (`idEvenement`, `titreEvenement`, `description`, `date_creation`, `date_debut`, `date_fin`, `idMembre`, `idCategorie`) VALUES
(1, 'Tommorrow Land', 'Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quis, necessitatibus maiores optio porro aliquid modi iusto tempora quas aperiam expedita vero. Magni dolorum nesciunt non ut, doloribus maxime temporibus labore!', '2018-10-26 00:00:00', '2018-11-09', '2018-11-11', 1, 1);
...
INSERT INTO `membre` (`idMembre`, `pseudo`, `password`, `mail`, `date_inscription`, `idGroupe`) VALUES
(1, 'admin', 'admin', 'admin@admin.com', '2018-10-26 00:00:00', 1);
