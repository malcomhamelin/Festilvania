...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  ven. 07 déc. 2018 à 17:01
...
--
-- Déchargement des données de la table `appartenircategorie`
--

INSERT INTO `appartenircategorie` (`idEvenement`, `idCategorie`) VALUES
(1, 1);
...
--
-- Déchargement des données de la table `appartenirgroupe`
--

INSERT INTO `appartenirgroupe` (`idMembre`, `idGroupe`) VALUES
(1, 1);
...
--
-- Déchargement des données de la table `autoriser`
--

INSERT INTO `autoriser` (`idGroupe`, `idDroits`) VALUES
(1, 1);
...
(1, 'Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quis, necessitatibus maiores optio porro aliquid modi iusto tempora quas aperiam expedita vero. Magni dolorum nesciunt non ut, doloribus maxime temporibus labore!', '2018-11-28 10:21:22', 1, 1),
(2, 'Bonjour', '2018-11-30 09:56:35', 1, 1),
(3, 'ALLELOUIA', '2018-11-30 09:56:44', 1, 1);
...
INSERT INTO `commenter` (`idMembre`, `idEvenement`, `idCommentaire`) VALUES
(1, 1, 1);
...
INSERT INTO `droits` (`idDroits`, `intituleDroits`, `droit_visualiser`, `droit_poster`, `droit_voter`, `droit_commenter`, `droit_editer`, `droit_supprimer`) VALUES
(1, 'root', 1, 1, 1, 1, 1, 1);
...
INSERT INTO `evenement` (`idEvenement`, `titreEvenement`, `description`, `date_creation`, `date_debut`, `date_fin`, `idMembre`, `idCategorie`, `lieu`) VALUES
(1, 'Tommorrow Land', 'Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quis, necessitatibus maiores optio porro aliquid modi iusto tempora quas aperiam expedita vero. Magni dolorum nesciunt non ut, doloribus maxime temporibus labore!', '2018-10-26 00:00:00', '2018-11-09', '2018-11-11', 1, 1, 'Bruxelles'),
(3, 'ifnezif', 'frfrrz', '2018-11-30 11:42:05', '2018-11-30', '2018-12-21', 1, 1, 'CREIL'),
(4, 'test', 'Lorem ipsum', '2018-12-07 08:32:20', '2018-12-01', '2018-12-08', 1, 1, 'Paris');
...
INSERT INTO `illustrer` (`idImage`, `idEvenement`) VALUES
(1, 1);
...
CREATE TABLE IF NOT EXISTS `membre` (
  ...
  `avatar` varchar(64) NOT NULL DEFAULT 'img/avatars/user.png',
  `idGroupe` bigint(20) UNSIGNED NOT NULL,
...
INSERT INTO `membre` (`idMembre`, `pseudo`, `password`, `mail`, `date_inscription`, `avatar`, `idGroupe`, `sexe`, `date_anniversaire`) VALUES
(1, 'admin', 'admin', 'admin@admin.com', '2018-10-26 00:00:00', 'img/avatars/admin.png', 1, '', NULL);
...
INSERT INTO `poster` (`idMembre`, `idEvenement`) VALUES
(1, 1);
...
(1, 1, 1, '2018-12-07 12:08:00'),
(1, 3, 1, '2018-12-07 12:19:28'),
(1, 4, -1, '2018-12-07 12:39:46');
